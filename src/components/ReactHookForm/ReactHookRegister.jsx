                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    ...
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)} className="fieldset">
                            ...
                            <input type="text" name="name" className="input space-y-5" placeholder="Full Name" {...register("fullName", { required: true })} />
                            {errors.fullName && <span className="text-red-500">This field is required</span>}

                            {/* <label className="label">Photo</label>                            
                            <input type="text" name="photo" className="input space-y-5" placeholder="Photo Link" {...register("photo", { required: true })} />
                            ...
                            <input type="password" name="confirm" className="input space-y-5" placeholder="Confirm Password" {...register("confirm", { required: true })} />
...
export default ReactHookRegister;